#ifndef _ZDA_LIBC_ALLOCATOR_WITH_REALLOC_H_
#define _ZDA_LIBC_ALLOCATOR_WITH_REALLOC_H_
...
class LibcAllocatorWithRealloc {
 public:
  ...
  T *allocate(size_type n) noexcept { return reinterpret_cast<T *>(::malloc(n * sizeof(T))); }
