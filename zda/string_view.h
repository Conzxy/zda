...
/* Initializer APIs */
/**************************/
static zda_inline void zda_string_view_init(zda_string_view_t *view,
                                            char const *data,
...
static zda_inline size_t zda_string_view_search(zda_string_view_t const *view,
...
static zda_inline size_t zda_string_view_search_char(
...
static zda_inline size_t zda_string_view_rsearch(zda_string_view_t const *view,
                                                 zda_string_view_t str,
                                                 size_t pos) zda_noexcept
{
  if (str.len != 0) {
...
static zda_inline size_t zda_string_view_rsearch_char(
    zda_string_view_t const *view, char c, size_t pos) zda_noexcept
{
  size_t len = zda_min(view->len - 1, pos);
  for (;; --len) {
...
{
  return ZDA_STRING_VIEW_NPOS != zda_string_view_search(view, str, 0);
}

static zda_inline zda_bool zda_string_view_contains_char(
    zda_string_view_t const *view, char c) zda_noexcept
{
  return ZDA_STRING_VIEW_NPOS != zda_string_view_search_char(view, c, 0);
}
