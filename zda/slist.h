...
static zda_inline zda_slist_node_t *zda_slist_get_header_node(zda_slist_header_t *header
) zda_noexcept
{
    return &header->node;
}
...
#define zda_slist_init        zda_slist_sentinel_init

static zda_inline void zda_slist_move(zda_slist_t *list, zda_slist_t *rhs) zda_noexcept
{
    list->node = rhs->node;
    zda_slist_sentinel_init(rhs);
}

static zda_inline void zda_slist_swap(zda_slist_t *list, zda_slist_t *rhs) zda_noexcept
{
    zda_swap(&list->node, &rhs->node, zda_slist_node_t);
}
