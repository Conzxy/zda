...
class Ht
 ...
 public:
    ...
    using const_iterator = HtConstIterator<entry_type>;
    ...
    const_iterator begin() const noexcept { return zda_ht_get_first((zda_ht_t *)&ht_); }
    iterator       begin() noexcept { return zda_ht_get_first((zda_ht_t *)&ht_); }
    const_iterator end() const noexcept { return zda_ht_get_terminator((zda_ht_t *)&ht_); }
    iterator       end() noexcept { return zda_ht_get_terminator((zda_ht_t *)&ht_); }
